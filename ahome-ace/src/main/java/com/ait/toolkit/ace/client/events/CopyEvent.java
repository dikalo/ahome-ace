 ...
 * 
 */
public class CopyEvent extends JsObject {

	public static String EVENT_NAME = "copy";
	...
	public CopyEvent(JavaScriptObject jsObj) {
		super(jsObj);
	}

	public CopyEvent(AceEditor source, String data) {
		this.source = source;
		this.text = data;
	}
